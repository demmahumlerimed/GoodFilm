...
import {
  CatalogStatusBadge, CatalogGridCard, CatalogListRow,
...
// ── PersonModal extracted → src/components/media/PersonModal.tsx ──────────────
// PersonModal is now imported at the top of this file.

// (kept below only for type re-use inside DetailModal)
type PersonDetail = {
  id: number;
  name: string;
  biography?: string;
